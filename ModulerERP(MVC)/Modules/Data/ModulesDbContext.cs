...
namespace ModulerERP_MVC_.Modules.Data
{
    public class ModulesDbContext : IdentityDbContext<ApplicationUser, IdentityRole<Guid>, Guid>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TaxProfileComponent>().HasQueryFilter(tpc => !tpc.IsDeleted); // <<<< أضف ده
        ...
        private void ConfigureRelationships(ModelBuilder modelBuilder)
        {
            ...
            // <<<< أضف ده - TaxProfileComponent relationships (Many-to-Many)
            modelBuilder.Entity<TaxProfileComponent>()
           .HasKey(tpc => new { tpc.TaxProfileId, tpc.TaxComponentId });

            // TaxProfile -> TaxProfileComponent (One-to-Many)
            modelBuilder.Entity<TaxProfileComponent>()
            ...
            // TaxComponent -> TaxProfileComponent (One-to-Many)
            modelBuilder.Entity<TaxProfileComponent>()
            ...
            // Soft Delete Filter
            modelBuilder.Entity<TaxProfileComponent>()
                .HasQueryFilter(tpc => !tpc.IsDeleted);

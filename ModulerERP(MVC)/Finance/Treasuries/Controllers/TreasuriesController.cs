...
namespace ModulerERP_MVC_.Finance.Treasuries.Controllers
{
    public class TreasuriesController : Controller
    {
        ...
        public async Task<IActionResult> Index(TreasuryStatus? status, string searchTerm)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "An error occurred while loading treasuries";
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "An error occurred while loading treasury details";
        ...
        public async Task<IActionResult> Create(TreasuryViewModel viewModel)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    TempData["Success"] = "Treasury created successfully";
                    return RedirectToAction(nameof(Index));
                }
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "An error occurred while creating the treasury";
                await PopulateDropdownsAsync();
                return View(viewModel);
            }
        }
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "An error occurred while loading treasury data";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        public async Task<IActionResult> Edit(Guid id, TreasuryViewModel viewModel)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    TempData["Success"] = "Treasury updated successfully";
                    return RedirectToAction(nameof(Index));
                }
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "An error occurred while updating the treasury";
                await PopulateDropdownsAsync(viewModel.CompanyId, viewModel.CurrencyCode);
                return View(viewModel);
            }
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            try
            {
                ...
                TempData["Success"] = "Treasury deleted successfully";
                return RedirectToAction(nameof(Index));
            }
            catch (InvalidOperationException ex)
            {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "An error occurred while deleting the treasury";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        public async Task<IActionResult> Balance(Guid? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "An error occurred while loading treasury balance";
                return RedirectToAction(nameof(Index));
            }
        }
